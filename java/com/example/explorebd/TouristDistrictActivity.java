...
public class TouristDistrictActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<String> districts = DataProvider.getTouristDistrictsByDivision(division);
        ...
        listView.setOnItemClickListener((adapterView, view, i, l) -> {
            Intent intent = new Intent(this, TouristPlaceListActivity.class);
